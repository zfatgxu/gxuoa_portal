<template>
  <div v-if="!disabled" class="upload-file">
    ...
    <div v-if="fileList.length > 0" class="file-table-container">
      <el-table :data="fileList" size="small" border style="width: 100%; margin-top: 10px;">
...
import { useUploadWithId } from '@/components/UploadFile/src/useUpload'
...
const { uploadUrl, httpRequest } = useUploadWithId(props.directory)

// 文件上传之前判断
const beforeUpload: UploadProps['beforeUpload'] = (file: UploadRawFile) => {
  nowName.value = file.name
