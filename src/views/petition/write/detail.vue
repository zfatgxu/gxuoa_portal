    ...
    <div class="processInstance-wrap-main">
      <el-scrollbar>
        ...
        <div class="flex items-center gap-5 mb-10px h-40px">
          <div class="text-26px font-bold mb-5px">广西大学信访单</div>
          <dict-tag
                  ...
                  <el-col :span="17" class="!flex !flex-col formCol">
                    ...
                    >
                      ...
                      <div v-if="processDefinition?.formType === BpmModelFormType.CUSTOM">
                        <!-- 督办单详情 -->
                        <component
                          v-if="processDefinition?.formCustomViewPath?.includes('petition')"
...
import PetitionOperationButton from '@/views/petition/petitioner/components/PetitionOperationButton.vue'
