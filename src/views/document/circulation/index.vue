  ...
  <ContentWrap>
    ...
    <div class="mb-4">
      <el-radio-group v-model="queryParams.type" @change="handleTypeChange">
        <el-radio-button :label="1">校内呈文（全部）</el-radio-button>
        <el-radio-button :label="3">学校发文（全部）</el-radio-button>
        <el-radio-button :label="2">校外来文（全部）</el-radio-button>
        <el-radio-button :label="4">校外来文（会议、报送材料等）</el-radio-button>
        <el-radio-button :label="5">请假文件（全部）</el-radio-button>
        <el-radio-button :label="6">全部退文</el-radio-button>
      </el-radio-group>
    </div>
      ...
      <el-table-column label="流转状态" align="center" min-width="120">
        <template #default="scope">
          <div class="flex items-center justify-center gap-1">
            ...
            <span v-if="scope.row.status === 1" class="text-red-600 text-sm font-medium">未处理</span>
          </div>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <!-- <el-button
            link
            type="danger"
            v-hasPermi="['document:circulation:sms']"
          >
          督办
          </el-button> -->
          ...
          <el-button
            ...
            v-hasPermi="['document:circulation:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['document:circulation:delete']"
          >
           删除
          </el-button>
          <el-button
