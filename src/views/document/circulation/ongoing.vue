  ...
  <ContentWrap>
    ...
    <div class="mb-4">
      <el-radio-group v-model="queryParams.type" @change="handleTypeChange">
        <el-radio-button :label="1">校内呈文（在办）</el-radio-button>
        <el-radio-button :label="3">学校发文（在办）</el-radio-button>
        <el-radio-button :label="2">校外来文（在办）</el-radio-button>
        <el-radio-button :label="5">请假文件（在办）</el-radio-button>
      </el-radio-group>
    </div>
